...
chanlocs = temp_EEG.chanlocs; %% this tries to get the labels, but actually for some reason, events is always shifted over to become the first label. So if you want the true label, you are gonna want to extract the first channel to the 23rd channel.
