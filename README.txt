-Each of the programs have their own readme in the metadata section, are documented. This is more of a broad explanation. Process-oriented notes are stored in Report in the Boosting pt 2 + LSTM folder. 
...
3. Boosting: In-sample LDA and generates the ictals and the n highest power interictals - 176 feature.
Input: P(Insert patient number)_FullPSD_176 - Features
Output: P(Insert patient number)_BoostedPSD_176.mat
